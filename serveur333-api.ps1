...
# Écouter sur toutes les interfaces réseau (méthode plus compatible)
try {
    ...
    try {
        ...
        Write-Host "⚠️  Écoute en local uniquement (localhost:$port)" -ForegroundColor Yellow
    }
}
...
try {
    ...
    Write-Host "🔗 URLs d'écoute actives:" -ForegroundColor Magenta
